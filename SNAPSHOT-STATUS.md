...
The combat and expedition work is integrated as of 2026-09-23. Melee, projectile, and area damage respect room walls; route travel requires a nearby safe gate; dangerous areas have persistent three-seal objectives and guarded caches; encounter health, loose loot, boss phase, seals, and claimed rewards use backward-compatible version 3 saves. Cleared dangerous areas receive delayed resource patrols so crafting materials remain renewable. Enemy attacks expose wind-up, strike, and recovery cues, the HUD is compact, and lifesteal uses damage actually dealt rather than requested damage.

The build entry **Ashfall > Build Windows** outputs `Builds/ExpeditionIntegration/Ashfall.exe`. This build passed the beta, world, item, detail/navigation, weapon, and rig executable QA suites. Visible 1280x720 captures were reviewed for the compact HUD, atlas, and enemy wind-up cue.
